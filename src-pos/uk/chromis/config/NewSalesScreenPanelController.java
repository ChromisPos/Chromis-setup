 ...
 * @author John.Lewis
 */
public class NewSalesScreenPanelController implements Initializable, BaseController {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        image0.setImage(IconFactory.getImage("panelleft.png"));
        image1.setImage(IconFactory.getImage("panelright.png"));
        ...
        rbtnLayout0.setOnAction(event -> leftPanel = true);

        rbtnLayout1.setOnAction(event -> leftPanel = false);
    ...
    @Override
    public void load() {
        leftPanel = SystemProperty.NEWPANELLEFT;        
        if (SystemProperty.NEWPANELLEFT) {
    ...
    @Override
    public void save() {
        SystemProperty.updatePropertyValueByConstant("NEWPANELLEFT", leftPanel);
        dirty.set(false);
    }
